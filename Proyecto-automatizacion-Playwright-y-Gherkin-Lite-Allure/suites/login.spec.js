...
feature('Autenticación en OrangeHRM', () => {
  ...
  // ==================== ESCENARIO 1 ====================
  scenario('Inicio de sesión exitoso con credenciales válidas', async ({ page }) => {
    ...
    await when('ingresa credenciales válidas', async () => {
      const credenciales = { username: 'Admin', password: 'admin123' };
      ctx.username = credenciales.username;
  ...
  // ==================== ESCENARIO 4 ====================
  scenario('Validar elementos visuales de la página de login', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  // ==================== ESCENARIO 5 ====================
  scenario('Mostrar mensajes de error con campos vacíos', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  // ==================== ESCENARIO 6 ====================
  scenario('Mostrar mensaje de validación con usuario vacío', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  // ==================== ESCENARIO 7 ====================
  scenario('Mostrar mensaje de validación con password vacío', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  // ==================== ESCENARIO 8 ====================
  scenario('Validar textos de ejemplo en campos de entrada', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  // ==================== ESCENARIO 9 ====================
  scenario('Validar enlaces a redes sociales', async ({ page, context }) => {
    const loginPage = new LoginPage(page);
    ...
    await then('al hacer clic en LinkedIn debe abrir una nueva pestaña', async () => {
  ...
  // ==================== ESCENARIO 10 ====================
  scenario('Validar enlace de "Forgot your password"', async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  // ==================== ESCENARIO 11 ====================
  scenario('Validar enlace de copyright', async ({ page, context }) => {
    const loginPage = new LoginPage(page);
    ...
    await then('debe abrir una nueva pestaña con el sitio de OrangeHRM', async (result) => {
